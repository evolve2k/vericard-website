...
export const siteName = 'Vericard';
export const siteDescription = 'Veri easy age verification';
export const siteType = 'Person'; // schema
export const locale = 'en_EN';
export const lang = 'en';
export const skipContent = 'Skip to content';
export const author = {
  name: 'Vericard', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'hello@vericard.digital', // i.e. hola@lenesaile.com - email of the author
  website: 'https://vericard.digital', // i.e. https.://www.lenesaile.com - the personal site of the author
